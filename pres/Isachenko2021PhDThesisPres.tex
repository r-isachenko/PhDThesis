...
\begin{block}{Функция потерь линейной регрессии}
	\vspace{-0.4cm}
	\[
...
\begin{block}{Метод проекции в скрытое пространство (PLS)}
	\vspace{-0.7cm}
	\begin{align*}
...
\begin{figure}
	\includegraphics[width=0.85\linewidth]{figs/ecog_data}
\end{figure}
\begin{minipage}{.55\linewidth}
\begin{itemize}
...
\begin{block}{Выступления с докладом}
	...
	\begin{enumerate}
		...
		\item  Intelligent Data Processing Conference, 2018, Dimensionality reduction for
		multicorrelated signal decoding with projections to latent space. 
