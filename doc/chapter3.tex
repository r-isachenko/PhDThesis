...
\textbf{Агрегация релевантностей целевых переменных.}
...
На~\autoref{ch2:fig:corr_matrix} Рис.~\ref{ch2:fig:corr_matrix} показаны матрицы корреляций для исходных матриц~$\bX$ и~$\bY$ данных ECoG. Частоты в матрице~$\bX$ сильно коррелированы. 
